...
function quickSort(arr, key) {
    let sortedArray = [...arr]; // Create a copy of the original array
    let stack = []; // Stack to keep track of low and high indices
...
const combinedDataset = [...l1, ...l2, ...l3, ...mc, ...mp];
const DictList = {
    "L1": l1,
    "L2": l2,
    "L3": l3,
...
const adjacencyMatrix = Array(size).fill(null).map(() => Array(size).fill(0));
...
function generateMatrixHTML(matrix, vertices) {
    let html = `
...
function bfsShortestPath(startNode, endNode, graph) {
    ...
    while (queue.length > 0) {
        ...
        if (!visited.has(currentNode)) {
            ...
            const neighbors = ((_a = graph.find(node => node.Nombre === currentNode)) === null || _a === void 0 ? void 0 : _a.neighbors) || [];
...
(_a = document.getElementById("findPath")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
    ...
    if (source && destination) {
        ...
        if (shortestPath) {
            ...
            const busStations = (shortestPath === null || shortestPath === void 0 ? void 0 : shortestPath.map(stationName => {
